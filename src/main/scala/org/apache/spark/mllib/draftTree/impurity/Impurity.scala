 ...
 */
private[draftTree] abstract class ImpurityAggregator(val statsSize: Int) extends Serializable {
 ...
 */
private[draftTree] abstract class ImpurityCalculator(val stats: Array[Double]) {

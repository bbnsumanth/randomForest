...
package org.apache.spark.mllib.draftTree.impurity

//import org.apache.spark.mllib.draftTree.impurity.Entropy;
...
object Entropy extends Impurity {
  ...
  private[draftTree] def log2(x: Double) = scala.math.log(x) / scala.math.log(2)
 ...
 */
private[draftTree] class EntropyAggregator(numClasses: Int)
 ...
 */
private[draftTree] class EntropyCalculator(stats: Array[Double]) extends ImpurityCalculator(stats) {
